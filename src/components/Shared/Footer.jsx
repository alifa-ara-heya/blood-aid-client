            ...
            <div className="w-3/4  mx-auto">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="space-y-2 md:w-1/3 w-full">
                        ...
                        <h2 className="text-xl font-semibold inline">Blood Aid</h2>
                        ...
                        <div className="py-4">
                            <button className="btn bg-[#FCE0A2] text-black font-bold hover:bg-yellow-100 focus:ring-2 focus:ring-yellow-400 ">
                    ...
                    {/* Contact Information */}
                    <div className="space-y-2  md:w-1/3 w-full flex-1">
                        <h3 className="text-lg md:text-xl font-bold mb-4">Get in Touch</h3>
                        <p className="text-sm flex gap-2">
                            <FaLocationDot className="text-lg md:txt-xl" /> 123 Main Street, Your City, Your Country
                        </p>
                        <p className="text-sm flex gap-2"><FaPhone className="text-lg md:txt-xl" /> +123 456 7890</p>
                        <p className="text-sm flex gap-2"><FaEnvelope className="text-lg md:txt-xl" /> support@bloodaid.com</p>
